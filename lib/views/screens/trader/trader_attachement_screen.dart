                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      border:
                                                                          Border
                                                                              .all(
                                                                        color: orderBrokerProvider.packageTypeId ==
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child: orderBrokerProvider
                                                                        .attachments
                                                                        .singleWhere((it) => it!.attachmentType == attachmentTypeState.attachmentTypes[0].id,
                                                                            orElse: () => Attachment(
                                                                                id:
                                                                                    0))
                                                                        .id !=
                                                                ...
                                                                ? SizedBox(
                                                                    ...
                                                                    child: Wrap(
                                                                      children: _buildAttachmentImages(orderBrokerProvider
                                                                          .attachments
                                                                          .singleWhere(
                                                                              (it) => it!.attachmentType == attachmentTypeState.attachmentTypes[0].id,
